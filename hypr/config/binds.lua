...
hl.bind("Print", hl.dsp.exec_cmd("/home/alberic/.local/bin/rishot"))
...
-- Belgische (BE) layout keysyms voor workspaces 1 t/m 9
local be_keys = { "ampersand", "eacute", "quotedbl", "apostrophe", "parenleft", "minus", "egrave", "underscore",
    "ccedilla" }

for i, key in ipairs(be_keys) do
    -- Wisselen van workspace (SUPER + leesteken)
    hl.bind("SUPER + " .. key, hl.dsp.focus({ workspace = i }))

    -- Venster verplaatsen naar workspace (SUPER + SHIFT + leesteken)
